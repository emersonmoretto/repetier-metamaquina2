...
#define XAXIS_STEPS_PER_MM 100 //AXIS_STEPS_PER_MM

/** \brief Number of steps for a 1mm move in y direction. Overridden if EEPROM activated.*/
#define YAXIS_STEPS_PER_MM 100//AXIS_STEPS_PER_MM

/** \brief Number of steps for a 1mm move in z direction  Overridden if EEPROM activated.*/
#define Z_THREAD_PITCH 1.25
#define ZAXIS_STEPS_PER_MM 2560 //(MICRO_STEPS * STEPS_PER_ROTATION / Z_THREAD_PITCH)  
...
for more details.
*/
#define GENERIC_THERM1_BETA 4000
...
#define MOTOR_CURRENT {110,110,135,135,90} // {X, Y, Z, E1, E2}
